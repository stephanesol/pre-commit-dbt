...
MANIFEST = {
    "nodes": {
        ...
        "model.with_materialized": {"materialized": "view"},
        "model.with_materialized_table": {"materialized": "table"},
        "model.with_materialized_empty": {"materialized": ""},
        "model.without_materialized": {"database": "prod", "schema": "test"},
