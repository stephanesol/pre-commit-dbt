...
MANIFEST = {
    "nodes": {
        ...
        "model.with_materialized": {"config": {"materialized": "view"}},
        "model.with_materialized_table": {"config": {"materialized": "table"}},
        "model.with_materialized_empty": {"config": {"materialized": ""}},
        "model.without_materialized": {"database": "prod", "schema": "test", "config": {}},
